    ...
    if (ab && ab.type === "ditem") {
        ...
        if (ab && ab.type === "theme") {
            ...
            if (ab && ab.type === "perspective") {
                var ad = ac
                    .selectAll(".pair")
                    .data(A.get(ab.group).filter(function (ae) {
                        return ae !== ab
                    }), u);
                ad
                    .enter()
...
function z() {
    ...
    B
        ...
        .sort(function (Y, X) {
            ...
            var aa = k.map[Y.canonicalKey]
                    ? 1
                    : 0,
                Z = k.map[X.canonicalKey]
                    ? 1
                    : 0;
            return aa - Z
        });
